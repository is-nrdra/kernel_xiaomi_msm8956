...
export CROSS_COMPILE=/home/rio/nad/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
export ARCH="arm64"
export USE_CCACHE=1

echo -e "$green***********************************************"
echo  "           Compiling LontongSayur Kernel                  "
echo -e "***********************************************"
